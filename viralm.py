...
parser.add_argument('--len', '-l', type=int, help='predict only for sequences >= len bp (default: 500)', default=500)
parser.add_argument('--threshold', '-t', type=float, help='threshold for prediction (default: 0.5)', default=0.5)
